...
class XMLTranslationTool(ToolWrapper):
    ...
    description = "This is a tool that translates the content of XML files from one language to another."


    def run(self, relative_path: str, *args, **kwargs) -> str:
        ...
        if not os.path.exists(reference_data_path):
            return "The mentioned path was not found"
